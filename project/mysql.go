...
func (s *MySQLStore) GetByID(ctx context.Context, id uint) (*Project, error) {
	var project Project
...
func (s *MySQLStore) ListByOwner(ctx context.Context, ownerID uint, limit, offset int) ([]*Project, error) {
